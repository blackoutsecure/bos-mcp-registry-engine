...
const PROJECT_CONFIG = {
  metadata: {
    ...
    generatedPage: {
      generatedBy: 'Blackout Secure MCP Registry Engine',
      maintainedBy: 'Blackout Secure',
      maintainerUrl: 'https://blackoutsecure.app',
      footerGeneratedByPrefix: 'Generated by',
      footerMaintainedByPrefix: 'Maintained by',
      commentHeader: 'Generated file metadata',
      commentGeneratedByLabel: 'Generated by',
      commentMaintainerLabel: 'Maintained by',
      commentProjectUrlLabel: 'Project URL',
      commentFormatVersionLabel: 'Metadata standard',
      commentFormatVersion: 'oss-v1',
    },
  },
  runtime: {
    defaults: {
